...
class Complex:
    ...
    def __mul__(self, other): # Умножение
        return Complex(self.real * other.real - self.image * other.image, self.real * other.imag + self.image * other.real)
    def __truediv__(self, other):
        divisor = other.real ** 2 + other.image ** 2
        real = (other.real * other.real + self.image * other.image)/divisor
