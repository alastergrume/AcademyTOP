...
# Метод .find() Выводит индекс первого вхождения элемента с начала строки. Можно указать начало и конец поиска. Ищет с начала.
print(myStr.find("p"))
# Метод .rfind() Выводит индекс первого вхождения элемента с конца строки. Если нет значения выведет -1
print(myStr.rfind("a"))
# Метод .rindex() Работает как rfind, но если не будет значения, то вернет ошибку
print(myStr.rindex("P"))

# Методы проверки начала или конца строк. Явлаются логичесиким, возвращают булево значение
# Метод .andswitch() Заканчивается ли строка этим символом, принимает итервалы
print(myStr.endswith("a"))
# Метод .startswitch() Заканчивается ли строка этим символом, принимает интервалы
print(myStr.startswith("P"))

# Методы проверки строк. Они все логические

# .isalnum() В качестве параметра передается пустота. состоит ли строка из букв или цифр
print(myStr.isalnum())
# .isalpha() Состоит ли строка только из букв
print(myStr.isalpha())
# .isdigit() Состоит ли строка только из цифр
print(myStr.isdigit())
# .islower() Состоит ли строка только символов нижнего регистра
print(myStr.islower())
# .isupper() Состоит ли строка только из символов верхнего регистра
print(myStr.isupper())
# .isspace() Проверка на пробелы и табуляцию
print(myStr.isspace())
# .istitle() Начинается ли каждое последовательность символа после спецсимвола (пробела или переноса строки) с большой буквы
print(myStr.istitle())
